...
public class GroundEnemy : MonoBehaviour
{
    ...
    private bool WallInFront()
    {
        ...
        RaycastHit2D hit = Physics2D.Raycast(rayStart, Vector2.right * moveDirection.x, .51f, LayerMask.GetMask("Default"));
    ...
    private void OnCollisionEnter2D(Collision2D collision)
    {
        ...
        {
            collision.collider.gameObject.GetComponent<Playercontroller>().takeDamage(5);
        }
